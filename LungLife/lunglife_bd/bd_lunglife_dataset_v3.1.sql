...
-- Includes all tables with proper dependencies
-- ============================================
...
-- 2.7. TABLE: relation_patient_doctor (Patient-doctor assignments)
...
CREATE TABLE smoking_history (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT unique_current_status UNIQUE (patient_id) WHERE is_current_status = TRUE,
...
CREATE TABLE lifestyle_habits (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT idx_unique_current_habit UNIQUE (patient_id) WHERE is_current = TRUE
);
...
-- 3.13. PATIENT_COMORBIDITIES indexes
